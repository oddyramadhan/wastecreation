...
export default function Footer() {
  return (
    <footer>
      <div className="max-w-5xl px-4 pt-8 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div className="flex justify-center text-[#B66F04] text-opacity-[60%] sm:justify-start">
              <svg
                className="h-8"
                viewBox="0 0 118 24"
                fill="none"
        ...
        <div className="mt-6 border-t border-black">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            <p className="text-sm text-gray-900">
              ...
              <a
                className="inline-block text-gray-700 underline transition hover:text-gray-700"
                href="/"
              >
                Terms & Conditions
              </a>
